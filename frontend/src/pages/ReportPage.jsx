          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm text-center">
                <p className="text-3xl font-extrabold text-gray-900">
                  {summary.total_files_changed ?? summary.files_changed ?? 0}
                </p>
              ...
              <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm text-center">
                <p className="text-3xl font-extrabold text-gray-900">
                  {summary.total_symbols_changed ?? summary.symbols_changed ?? 0}
                </p>
              ...
              <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm text-center">
                <p className="text-3xl font-extrabold text-blue-600">
                  {summary.total_affected_symbols ?? summary.blast_radius_count ?? report.blast_radius?.total_affected_count ?? 0}
                </p>
              ...
              <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm text-center">
                <p
                  className={`text-3xl font-extrabold ${
                    (summary.regressions_count ?? summary.regressions ?? 0) > 0
                      ? 'text-red-600'
                      : 'text-gray-900'
                  }`}
                >
                  {summary.regressions_count ?? summary.regressions ?? 0}
                </p>
              ...
              <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm text-center">
                <p className="text-3xl font-extrabold text-gray-900">
                  {summary.total_tests_run ?? summary.tests_run ?? 0}
                </p>
            ...
            {ai && (
              <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm space-y-4">
                ...
                <div>
                  <p className="text-xs font-semibold text-gray-500 uppercase">Migration Intent</p>
                  <p className="text-sm text-gray-800 mt-1">{ai.migration_intent}</p>
                </div>
                <div>
                  <p className="text-xs font-semibold text-gray-500 uppercase">Risk Summary</p>
                  <p className="text-sm text-gray-800 mt-1">{ai.risk_summary}</p>
                </div>
                {ai.key_concerns && ai.key_concerns.length > 0 && (
                  <div>
                    ...
                    <ul className="list-disc list-inside text-sm text-gray-800 space-y-1">
                      {ai.key_concerns.map((concern, idx) => (
